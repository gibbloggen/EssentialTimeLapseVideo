...

{
	...
	//This is Microsoft Stuff,,,   https://docs.microsoft.com/en-us/windows/uwp/audio-video-camera/set-media-encoding-properties
	class StreamPropertiesHelper
	{
		...
		public string GetFriendlyName(bool showFrameRate = true)
		{
			...
			{
				string vidType;
				if (_properties.Subtype == "{30323449-0000-0010-8000-00AA00389B71}") vidType = "I420"; else vidType = _properties.Subtype;
				return Width + "x" + Height + " [" + AspectRatio + "] " + FrameRate + "FPS " + vidType;
			}
